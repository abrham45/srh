from .models import AGE_RANGES, GENDERS, INTEREST_AREAS, RATING_CHOICES, INTENT_CHOICES, EMOTION_CHOICES, EMOTION_RATING_CHOICES, REGIONS, RISK_LEVEL_CHOICES, MYTH_DETECTION_CHOICES
